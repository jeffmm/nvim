return {
  ...
  version = "*", -- recommended for stability, uses latest release rather than latest commit
  lazy = true,
  -- Only load obsidian.nvim for markdown files in the obsidian vault:
  ft = "markdown",
  -- event = {
  ...
  -- },
  keys = {
    { "<leader>ww", "<cmd>ObsidianQuickSwitch<cr>", desc = "Recent" },
    {
      "<leader>wi",
      "<cmd>e ~/Library/Mobile Documents/iCloud~md~obsidian/Documents/Notes/notes/20250608125405-index.md<cr>",
      desc = "Index",
    },
    {
      "<leader>wo",
