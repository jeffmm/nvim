return {
	...
	config = function()
			...
			extensions = {
				project = {
					base_dirs = {
						...
						-- '~/Projects/market-framework',
						-- '~/Projects/market-ercot',
						-- '~/Projects/market-miso',
						-- '~/Projects/market-spp',
						-- '~/Projects/zge-schemas',
						-- '~/Projects/etl-jobs',
						-- '~/Projects/data-tools',
						-- '~/Projects/workflow-cli',
						-- '~/.config/nvim',
					},
		...
		vim.keymap.set("n", "<leader>fp", ":lua require'telescope'.extensions.project.project{}<CR>", { desc =
		"find projects" })
