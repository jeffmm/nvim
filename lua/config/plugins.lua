...
lazy.setup({
	spec = {
		...
		-- -- Git plugins, but using lazygit for now
		-- -- require("plugins.flog"),
		-- -- neogit conflicts with sneak/leap keybindings for some reason
		-- require("plugins.git"),
		...
		-- require("plugins.lsp"),
		-- require("plugins.cmp"),
		-- -- Xero's custom trouble plugin, but conflicts with folke's
		...
		-- require("plugins.notebook-navigator"),
